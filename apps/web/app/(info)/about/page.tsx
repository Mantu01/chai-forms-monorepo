...
export default function AboutPage() {
  return (
    <div className="min-h-screen bg-zinc-950 text-white flex flex-col items-center justify-center p-6 space-y-8 overflow-hidden">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-4xl w-full">
        ...
        <div className="p-5 rounded-2xl border border-zinc-800/80 bg-zinc-900/30 backdrop-blur-md space-y-3">
          <div className="h-8 w-8 rounded-lg bg-emerald-500/10 flex items-center justify-center border border-emerald-500/20 text-emerald-450">
      ...
      <div className="flex gap-4">
        <Link href="/dashboard">
          <Button className="rounded-xl h-10 px-5 gap-1.5 font-sans">
            <span>Get Started</span>
          </Button>
        </Link>
        <Link href="/profile">
          <Button variant="outline" className="rounded-xl h-10 px-5 gap-1.5 border-zinc-800 bg-zinc-900/40 font-sans">
